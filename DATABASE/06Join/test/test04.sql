...
(6, '웹 back-end 개발자', '인트라넷 개발	spring', 'spring 개발경력 3년이상', '계약직', '서울시 송파구', 7600, '2026-04-15'),
(6, '웹 back-end 개발자', '라이브 API 개발', 'spring 개발경력 3년이상', '정규직', '서울시 송파구', 7600, '2026-05-12');
...
SELECT company.name, recruit.position, recruit.qualification, recruit,type, recruit.salay
...
SELECT company.name, count(8) AS `count`, company.business, company.headcount
FROM `company`JOIN `recruit`
ON company.id = recruit.companyId
