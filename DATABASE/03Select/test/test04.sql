...
ALTER TABLE `weatherhistory` ADD COLUMN `createdAt` TIMESTAMP DEFAULT CURRENT_TIMESTAMP AFTER `windspeed`;

ALTER TABLE `weatherhistory` ADD COLUMN `updatedAt` TIMESTAMP DEFAULT CURRENT_TIMESTAMP AFTER `windspeed`;
